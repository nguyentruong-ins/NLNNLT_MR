...
# from MIPSCodeGenerator import CodeGenerator
import subprocess
...
class TestCodeGen():
    ...
    def check(soldir,asttree,num):
        ...
        try:
            ...
            # For MIPS code
            proc = subprocess.run("java  -jar "+ MIPS_JAR + " " + path + "/MT22Class.asm",shell=True,stderr=subprocess.STDOUT, stdout=subprocess.PIPE)
